...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 left-0 z-30 flex h-16 justify-between bg-bg-black dark:bg-bg-dark-black-active md:h-screen md:w-24 md:flex-col md:items-center md:justify-between md:rounded-tr-[26px] md:rounded-br-[26px]">
